...
#   function reaction_path() which gets the speed in km/h as input, 
#   calculates the reaction path according to the above rule of thumb and returns the path in m
#   function brake_distance() which gets the speed in km/h as input, 
#   calculates the brake distance according to the above rule of thumb and returns the distance in m
...
def reaction_path(speed_of_reaction):
    result = int(speed_of_reaction) * 3 / 10
    return result 

def brake_distance(speed_of_brake):
    result = (int(speed_of_brake) / 10) ** 2
    return result
    
def stopping_distance(speed):
    result = reaction_path(speed) + brake_distance(speed)
    return result

print(stopping_distance(input()))